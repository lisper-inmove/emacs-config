...
#+begin_src emacs-lisp :outputs silent
  ...
  ;;   :custom
  ;;   (corfu-auto t)                     ;; 输入即弹出
  ;;   (corfu-auto-delay 0.1)             ;; 弹出延迟
  ;;   (corfu-auto-prefix 1)              ;; 几个字符后弹
  ;;   (corfu-cycle t)                    ;; 上下循环选择
  ;;   ;; 让 TAB 更“像 IDE”：先缩进，必要时触发补全
  ...
  ;;   :config
  ;;   ;; 指定 Python 用 jedi-language-server
  ;;   (add-to-list 'eglot-server-programs
  ;;                '((python-mode python-ts-mode)
  ;;                  . ("jedi-language-server"))))

  ;;（推荐）Orderless：更强的模糊匹配
  ...
  ;;
  ;; ;;（可选）Yasnippet：让 LSP snippets 能展开
