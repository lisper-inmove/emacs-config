...
(custom-set-variables
 ...
 '(package-selected-packages
   '(cmake-mode org-download highlight-symbol realgud prettier react-snippets js-react-redux-yasnippets flycheck-pycheckers flycheck-mypy lsp-tailwindcss tree-sitter-langs centered-cursor-mode toml-mode w3m rainbow-mode eglot emmet-mode scss-mode company-web dockerfile-mode lsp-java impatient-mode company-solidity solidity-flycheck solidity-mode cargo-mode cargo rust-mode ini-mode powerline flutter lsp-dart lua-mode org-bullets neotree neo-tree all-the-icons pyim-wudict pyim-wbdict pyim elisp-demos bm goto-last-change json-mode yaml-mode smartparens browse-kill-ring idle-highlight-mode rainbow-delimiters try protobuf-mode flycheck treemacs-magit flycheck-pyflakes flymake-python-pyflakes yasnippet-snippets yasnippet undo-tree treemacs-persp treemacs-icons-dired treemacs-projectile treemacs-evil treemacs htmlize helm-gtags helm-ls-git helm find-file-in-project elscreen counsel ace-window ace-jump-mode use-package)))
(custom-set-faces
