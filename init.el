...
(custom-set-variables
 ...
 '(package-selected-packages
   '(treemacs evil true cmake-mode yasnippet-snippets which-key py-isort protobuf-mode org-bullets orderless monokai-theme magit htmlize helm-ls-git helm-gtags git-gutter flycheck find-file-in-project exec-path-from-shell elscreen counsel company-irony-c-headers company-irony cargo ace-window)))
(custom-set-faces
