#+begin_src emacs-lisp :result silent
  ...
  ;; ;; 配置 latex-preview-pane
  ;; (use-package latex-preview-pane
  ;;   :ensure t
  ;;   :hook (LaTeX-mode . latex-preview-pane-enable) ;; 启用 LaTeX-mode 时自动启用预览
  ;;   :config
  ;;   ;; 设置 latex-preview-pane 的自动更新选项
  ;;   (setq latex-preview-pane-use-frame nil)) ;; 在当前窗口中显示预览
