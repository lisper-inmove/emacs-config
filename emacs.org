...
#+begin_src emacs-lisp
  ...
  (setq org-plantuml-jar-path "~/.emacs.d/jars/plantuml.jar")
...
#+BEGIN_SRC emacs-lisp
  (use-package highlight-symbol
    :defer 1
    :config
    (global-set-key (kbd "C-b b") 'highlight-symbol)
    (global-set-key (kbd "C-b n") 'highlight-symbol-next)
    (global-set-key (kbd "C-b p") 'highlight-symbol-prev))
#+END_SRC
* which key
#+BEGIN_SRC emacs-lisp
  (use-package which-key
    ...
    ;; (setq which-key-show-early-on-C-ht)
